  ...
  <section class="slideshow-container margins">
    ...
    <div class="slide">
      <img src="../assets/img/sights/tvrdjava/2.jpg" alt="Bačka tvrđava" />
    </div>
    <div class="slide">
      <img src="../assets/img/sights/tvrdjava/3.jpg" alt="Bačka tvrđava" />
    </div>
    <div class="slide">
      <img src="../assets/img/sights/tvrdjava/4.jpg" alt="Bačka tvrđava" />
    </div>
    <div class="slide">
      <img src="../assets/img/sights/tvrdjava/5.jpg" alt="Bačka tvrđava" />
    </div>
    <div class="slide">
      <img src="../assets/img/sights/tvrdjava/6.jpg" alt="Bačka tvrđava" />
    </div>
  ...
  <div class="dots">
    ...
    <div class="dot" onclick="showSlideDots(2)"></div>
    <div class="dot" onclick="showSlideDots(3)"></div>
    <div class="dot" onclick="showSlideDots(4)"></div>
    <div class="dot" onclick="showSlideDots(5)"></div>
  </div>
