    ...
    <section id="floatingPart" class="popupSection">
        <div class="split left">
            <div class="floatCard floatCardLeft">
                <!-- <h3 data-i18n="indexFloatMapHeadline" class="floatCardHeadline">Mapa</h3> -->
                <p><a href="/map" id="ancorLeft">MAPA</a> za čula svaka!</p>
            </div>
        </div>

        <div class="split right">
            <div class="floatCard floatCardRight">
                <!-- <h3 data-i18n="indexFloatCalendarHeadline" class="floatCardHeadlineRight">Kalendar</h3> -->
                <p data-i18n="indexFloatMapText1">Na <a href="/calendar" id="ancorRight">KALENDAR</a> stavi touch i planiraj dolazak u Bač
                </p>
            </div>
        </div>
        </div>
