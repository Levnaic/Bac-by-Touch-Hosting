<section id="dashBoardUpperPart" class="margins">
    <h1>Kontrolisanje Proizvođača</h1>
    <a href="/dashboard/producers/create" id="addMapLinkBtn" class="margins btnAdminNav">Dodaj Proizvođaća</a>
</section>
<!-- table with users -->
<section id="usersTable" class="margins">
    <table>
        ...
        <tr>
            <th class="otherTh">Naslov Firme</th>
            ...
            <tr>
                ...
                <td class="usersTableBtns">
                    <div class="tableBtnsContainer">
                        <a href="/dashboard/producers/update?id=<?php echo $row->id; ?>" class="adminAction firstActionBtn">Update</a>
                        <form action="/dashboard/producers/delete?id=<?php echo $row->id; ?>" method="POST" id="deleteForm_<?php echo $row->id; ?>">
